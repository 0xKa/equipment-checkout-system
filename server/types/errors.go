...
var (
	...
	ErrInvalidPassword          = errors.New("invalid temporary password")
	ErrIdentityNotLinked        = errors.New("identity is not linked to a local user")
...
const (
	...
	ErrorCodeInvalidUserRole        = "invalid_user_role"
